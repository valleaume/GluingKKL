classdef AugmentedSystem < HybridSystem  %cannot ihnerit from Observable sys?
    ...
    methods
        ...
        function DataSet = generateData(this, InitConditions, T_take, T_max, points_per_run, n_run)
            ...
            config = HybridSolverConfig('silent', 'AbsTol', 1e-3, 'RelTol', 1e-7, 'MaxStep', 0.01);
