...
% Train a SVM separating the z variable 
...
%%%% Other possibility : a random forest also exhibited good results
...
Y_after = data_3_labels(1:aug_sys.nx, mask_after)'; % We use the datascience notation X, Y, but note that here the X array consists of the z coordinates of points
...
Y_before = data_3_labels(1:aug_sys.nx, mask_before)'; % Likewise, Y consists of the x coorinates of points
...
% Test Neural Network
% Predict on test set
YPred_before = predict(mdl_b, X_test_before);
