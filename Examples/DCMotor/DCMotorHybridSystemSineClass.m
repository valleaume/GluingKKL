classdef DCMotorHybridSystemSineClass < HybridSubsystem
    % DCMotorHybridSystemSineClass: A hybrid system model of a DC motor with friction.
    ...
    methods
        function this = DCMotorHybridSystemSineClass()
            % Constructor for DCMotorHybridSystemClass.
            % Define state, input, and output dimensions.
            state_dim = 9;  % [current; omega; theta; mode; u_pulsation; u_amplitude; u; F_s; F_d]
        ...
        function xdot = flowMap(this, x, u, t, j)
            ...
            % Inputs:
            %   x: State vector [current; omega; theta; mode; u_pulsation; u_amplitude; u; F_s; F_d]
            ...
            u_state = x(this.u_state_index);
            u_dot = x(this.u_dot_index);
            pulsation = x(this.pulsation_index);
            ...
            d_pulsation_dt = 0; % Pulsation is constant

            % Return the state derivatives
            xdot = [di_dt; domega_dt; dtheta_dt; dmode_dt; du_dt; dudot_dt; dF_s_dt; dF_d_dt; d_pulsation_dt]; 
        end
